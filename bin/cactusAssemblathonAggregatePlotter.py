...
def initOptions( parser ):
   ...
   parser.add_option( '--mode', dest='mode',
                      ...
                      help='Plotting mode [normal|contamination].' )
...
def checkOptions( options, parser ):
   ...
   if options.mode != 'normal' and options.mode != 'contamination':
      parser.error('Error, you may specify either normal or contamination for --mode.\n')
